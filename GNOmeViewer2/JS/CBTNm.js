...
var CBTN = function () {
    ...
    function afterCompostionChanged() {
        ...
        findMatchedComposition();
    }

    function findMatchedComposition() {
        matchedCompositions = [];

        for (var acc of Object.keys(data_composition)){
            if (match2CurrentComposition(data_composition[acc].comp)){
                matchedCompositions.push(acc);
            }
        }
    }
    ...
    function updateRightPanel() {
        ...
        for (var gtcid of matchedCompositions) {
